...
Southeast Mississippi Rural Health Initiative, Inc. could not have achieved its current level of success without many effective partners in the community.  There are strong ties with Forrest General Hospital, the Mississippi Department of Health, several private physician offices, the University of Southern Mississippi, and many other social and educational agencies in Hattiesburg and the surrounding counties.
		...
		?><br>
                    ...
                    <div class="faq-content">
                        <?php if( have_rows('welcome_video') ): ?>

	
    

	<?php while( have_rows('welcome_video') ): the_row(); 
...
<?php endif; ?>
            ...
            <div class="media-title" onclick="toggle_visibility('patient_testimonials')" style="cursor:pointer">
            <div class="menu-title-text">
...
<div id="patient_testimonials" class="faq-content2">            
                     
                        
                        
                        <?php if( have_rows('patient_testimonials') ): ?>

	
    

	<?php while( have_rows('patient_testimonials') ): the_row(); 

		// vars
		$patient_video = get_sub_field('patient_video');
...
<?php if( $patient_video ): ?>
				<?php echo $patient_video; ?><br><br>
			<?php endif; ?>
...
<div class="media-title" onclick="toggle_visibility('local-recognition')" style="cursor:pointer">
									<div class="menu-title-text">
                                    Local Recognition
                                    </div>
                                    <div class="menu-title-image">
...
<div id="local-recognition" class="faq-content2">



<?php if( have_rows('local_recognition') ): ?>

	
    

	<?php while( have_rows('local_recognition') ): the_row(); 
