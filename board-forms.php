		...
		?>
                        ...
                        <div class="contact-sidebar-menu-item">
                        	<a href="javascript:showonlyone('<?php echo $patient_group_name; ?>');">
                                ...
                                <div id="<?php echo $patient_group_name; ?>" class="menu-item-contentb newboxes6" style="display:none;">
        	...
        	<div class="contact-menu-form-restricter">
                ...
                <div class="school-based-form-info-restricter">
                    <div class="school-based-form-info">
                        ...
                        <p style="font-weight:bold;">You must be logged in to view this content</p></br>
						<?php wp_login_form(); ?>
                        </div>
                    </div>
                </div>
...
<script type="text/javascript"> 
	...
	function showonlyone(thechosenone){      
     ...
     jQuery('.newboxes6').each(function(index) {
